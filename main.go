...
/*
getEnvVars returns app environment variables
*/
func getEnvVars() map[string]string {
	env := make(map[string]string)
	for _, e := range os.Environ() {
		evar := strings.SplitN(e, "=", 2)
		if len(evar) == 2 {
			env[evar[0]] = evar[1]
		}
	}
...
/*
getThreadDump function generates a thread dump of the current application's goroutines.
*/
func getThreadDump() ([]byte, error) {
	var buf bytes.Buffer
	profile := pprof.Lookup("goroutine")
	if profile == nil {
		return nil, errors.New("pprof profile not found")
	}
...
/*
The App type represents the application. It has four fields:
- Info of type InfoParams: It contains information about the application.
- Env of type map[string]string: It holds the environment variables of the application.
- Metrics of type MemStats: It represents the memory statistics of the application.
- Threaddump of type []byte: It stores the thread dump data.
*/
...
/*
code below is from https://github.com/sinhashubham95/go-actuator/blob/master/metrics.go
*/

func getRuntimeMetrics() MemStats {
